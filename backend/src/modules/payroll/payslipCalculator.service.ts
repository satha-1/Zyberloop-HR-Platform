  ...
  return {
    payslip: {
      employee: {
        ...
        joining_date: input.employee.joining_date || undefined,
      },
      company: {
        name: input.company?.name || undefined,
        address_line1: input.company?.address_line1 || undefined,
        address_line2: input.company?.address_line2 || undefined,
        pincode: input.company?.pincode || undefined,
        pan_or_tax_id: input.company?.pan_or_tax_id || undefined,
      },
      pay_period: {
